...
cl.exe /nologo /c /Od /MT /W0 /GS- /Tc findrwx.c /Fo:findrwx_x86.obj
move /y findrwx_x86.obj findrwx.x86.o

REM Build x64
call %VS_PATH%\vcvarsall.bat x64
cl.exe /nologo /c /Od /MT /W0 /GS- /Tc findrwx.c /Fo:findrwx_x64.obj
move /y findrwx_x64.obj findrwx.x64.o